...
class CrearLicenciatura extends Component
{
    ...
    public function guardarLicenciatura()
    {
        ...
        $this->validate([
            ...
            'logo' =>  'image|nullable|max:2048|mimes:jpeg,jpg,png',
            ...
            'logo.image' => 'El archivo debe ser una logo',
            'logo.max' => 'El archivo no debe pesar más de 2MB',
            'logo.mimes' => 'El archivo debe ser formato jpeg, jpg o png',
        ]);

        if ($this->logo) {
            $logo = $this->logo->store('licenciaturas');
        ...
        $this->reset(['nombre', 'RVOE', 'nombre_corto', 'logo', 'slug']);
