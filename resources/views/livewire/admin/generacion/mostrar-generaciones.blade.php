<div x-data="{
    ...
    <div
        ...
        <div class="w-full ">
            ...
            <div class="relative">
                ...
                <flux:input id="buscar-generacion" type="text" wire:model.live="search"
                    placeholder="Buscar generación..." class="pl-10 w-full" />
            </div>
        </div>
    ...
    <div class="relative">
        <!-- Loader overlay -->
        <div wire:loading.delay wire:target="search, eliminarGeneracion"
                                    ...
                                    <td colspan="6" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="mx-auto w-full max-w-md">
                                            <div
                                                ...
                                                <div class="mb-1 text-base font-semibold">No hay generaciones
                                                    disponibles</div>
