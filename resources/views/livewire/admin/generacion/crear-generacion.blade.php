<div>
    ...
    <div x-data="{ open: false }" class="my-4">
        <!-- Toggle -->
        <button type="button" @click="open = !open" :aria-expanded="open" aria-controls="panel-crear-generacion"
        ...
        <!-- Panel -->
        <div id="panel-crear-generacion" x-show="open" x-cloak x-transition:enter="transition ease-out duration-250"
            ...
            <form wire:submit.prevent="crearGeneracion" class="group">
                <div
                    ...
                    <div class="p-5 sm:p-6 lg:p-8">
                        ...
                        <flux:field>
                            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1  gap-4 items-start">
                                <flux:input badge="Requerido" wire:model="generacion"
                                    :label="__('Asigna la Generación: ej. 2020-2023')" type="text"
                                    placeholder="Ej. 2020-2023" autocomplete="generacion" />
                    ...
                    <div class="absolute inset-0 rounded-2xl bg-white/70 dark:bg-neutral-900/60 backdrop-blur-[2px] flex items-center justify-center z-10"
                        wire:loading wire:target="crearGeneracion">
                        <span
