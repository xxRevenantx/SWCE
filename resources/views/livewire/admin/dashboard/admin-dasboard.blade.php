<div class="flex w-full flex-1 flex-col gap-6">
                            ...
                            @foreach ($resumenPorLicenciatura as $resumen)
                                ...
                                <div class="rounded-xl ring-1 ring-neutral-200 dark:ring-neutral-700 p-3 sm:p-4">
                                    ...
                                    <div
                                        ...
                                        <div class="h-full bg-neutral-300 dark:bg-neutral-500"
    ...
    <div
        ...
        <div class="flex items-center justify-between gap-3 mb-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                    Activos e inactivos por sexo en cada licenciatura
                </p>
            </div>

            <button type="button" onclick="window.dispatchEvent(new CustomEvent('refrescar-grafica-dashboard'))"
        ...
        <div wire:ignore class="relative h-[360px] sm:h-[420px] lg:h-[520px]">
            <div id="graficaAlumnosApex" class="w-full h-full"></div>
        </div>
    </div>
    ...
    @once
        ...
        <script>
            ...
            function obtenerOpcionesGraficaDashboard() {
                ...
                return {
                    ...
                    series: @js($seriesGrafica),
                    xaxis: {
                        categories: @js($categoriasGrafica),
                        labels: {
                            style: {
                                colors: modoOscuro ? '#D4D4D8' : '#52525B',
                                fontSize: '12px',
                                fontWeight: 500
                            },
                            rotate: 0,
                    ...
                    legend: {
                        ...
                        fontSize: '13px',
                        labels: {
                            colors: modoOscuro ? '#E5E7EB' : '#374151'
                        }
                    },
                    plotOptions: {
                        bar: {
                    ...
                    colors: ['#2563EB', '#60A5FA', '#DC2626', '#FCA5A5'],
                    fill: {
                        opacity: 1
                    },
                    grid: {
                        borderColor: modoOscuro ? '#3F3F46' : '#E5E7EB',
                        strokeDashArray: 4
                    },
                    tooltip: {
            ...
            function destruirGraficaDashboard() {
                if (window.graficaDashboardApex) {
                    window.graficaDashboardApex.destroy();
                    window.graficaDashboardApex = null;
                }
            }

            function renderGraficaDashboard() {
                const contenedor = document.querySelector('#graficaAlumnosApex');
                if (!contenedor || typeof ApexCharts === 'undefined') {
                    return;
                }

                destruirGraficaDashboard();

                window.graficaDashboardApex = new ApexCharts(
                    contenedor,
                    obtenerOpcionesGraficaDashboard()
                );

                window.graficaDashboardApex.render();
            }

            document.addEventListener('livewire:init', () => {
                renderGraficaDashboard();

                Livewire.hook('morph.updated', ({
                    el,
                    component
                }) => {
                    if (document.querySelector('#graficaAlumnosApex')) {
                        renderGraficaDashboard();
                    }
                });
            });
            ...
            window.addEventListener('refrescar-grafica-dashboard', () => {
                renderGraficaDashboard();
            });
        </script>
    @endonce
