<div x-data="{
    ...
    <div
        ...
        <div class="w-full ">
            ...
            <div class="relative">
                ...
                <flux:input id="buscar-profesor" type="text" wire:model.live="search"
                    placeholder="Buscar profesor..." class="pl-10 w-full" />
            </div>
        </div>
    ...
    <div class="relative">
        <!-- Loader overlay -->
        <div wire:loading.delay wire:target="search, eliminarProfesor"
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-neutral-800">
                            @forelse($profesores as $key => $profesor)
                                <tr class="transition-colors hover:bg-gray-50/70 dark:hover:bg-neutral-800/50 }}">
                                    ...
                                    <td class="px-4 py-3 text-center text-gray-800 dark:text-gray-200">
                                        @if ($profesor->foto)
                                            <img src="{{ asset('storage/profesores/' . $profesor->foto) }}"
                                    ...
                                    <td class="px-4 py-3 text-center text-gray-900 dark:text-white">
                                        {{ $profesor->user->email }}</td>
                                    <td class="px-4 py-3 text-center text-gray-900 dark:text-white">
                                        {{ $profesor->perfil }}</td>
                                    <td class="px-4 py-3 text-center text-gray-900 dark:text-white">
                                        {{ $profesor->telefono }}</td>
                                    <td class="px-4 py-3 text-center text-gray-900 dark:text-white">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <flux:button variant="primary"
                                                href="{{ route('admin.profesores.credencial', ['id' => $profesor->id]) }}"
                                    ...
                                    <td colspan="8" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="mx-auto w-full max-w-md">
                                            <div
                                                ...
                                                <div class="mb-1 text-base font-semibold">No hay profesores disponibles
                                                </div>
