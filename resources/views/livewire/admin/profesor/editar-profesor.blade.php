...
>
  ...
  >
    ...
    <!-- Header (fijo) -->
    <div class="px-5 sm:px-6 pt-4 pb-3 flex items-start justify-between gap-3 sticky top-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur z-10">
      <div class="min-w-0">
    ...
    <!-- Body (scrollable) -->
    <div class="px-5 sm:px-6 pb-5 overflow-y-auto overscroll-contain flex-1 scrollbar-thin">
      <form wire:submit.prevent="actualizarProfesor" class="relative">
        <div>
          <flux:field>
            <!-- Grid de campos -->
              ...
              >
                ...
                <div wire:loading wire:target="foto_nueva" class="mt-3 flex items-center gap-2 text-blue-600 dark:text-blue-400">
                  <svg class="animate-spin h-5 w-5" viewBox="0 0 24 24" fill="none">
                    ...
                    <path class="opacity-75" fill="currentColor" d="M4 12a 8 8 0 0 1 8-8v8H4z"></path>
                  </svg>
          ...
          <div class="mt-6 sticky bottom-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur pt-3 pb-2 -mx-5 sm:-mx-6 px-5 sm:px-6 z-10">
