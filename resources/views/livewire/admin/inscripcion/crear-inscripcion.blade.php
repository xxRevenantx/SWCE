<div x-data="wizard({ initial: (localStorage.getItem('alumnoTabs') || 'generales'), persistKey: 'alumnoTabs' })" x-id="['tab']" x-init="init()"
    ...
    <style>
        ...
        .stage {
            position: relative;
            overflow: hidden;
            /* importante si las secciones son absolute */
    ...
    <header class="sticky top-0 z-20 mb-4 w-full">
        <div
            ...
            <div class="px-4 py-4">
                ...
                <p class="text-sm text-neutral-700 dark:text-neutral-300">Formulario para registrar nuevos estudiantes
                </p>
            </div>
            ...
            <div class="px-4 pb-4">
                ...
                <nav class="mt-3 relative overflow-x-auto no-scrollbar" role="tablist"
                    aria-label="Secciones del formulario" @keydown.right.prevent="focusNext()"
                    ...
                    <ul class="inline-flex items-center gap-2 md:gap-3">
                        <template x-for="step in steps" :key="step.name">
                         ...
                         focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"
                                    role="tab" :tabindex="is(step.name) ? 0 : -1" :id="tabId(step.name)"
                                    :aria-controls="panelId(step.name)" :aria-selected="is(step.name)"
                                    @click="go(step.name)" @keydown.enter.prevent="go(step.name)">
                                    <span
    ...
    <div>
        <div class="stage" x-ref="stage" wire:ignore.self>
            <!-- Generales -->
            <section x-cloak x-show="is('generales')"
                ...
                role="tabpanel" :id="panelId('generales')" :aria-labelledby="tabId('generales')" data-panel="generales"
                class="absolute inset-0 w-full">
                <div
                    class="card-surface rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm w-full">
                    <div
                    ...
                    <div class="px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model.live="pais_nacimiento" placeholder="Selecciona un país..."
                                wire:key="country-select">
                                <flux:select.option value="">--Selecciona un país de Nacimiento--
                                </flux:select.option>
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model.live="estado_nacimiento"
                                ...
                                <flux:select.option value="">--Selecciona un estado de Nacimiento--
                                </flux:select.option>
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model.live="lugar_nacimiento"
                                ...
                                <flux:select.option value="">--Selecciona una ciudad de Nacimiento--
                                </flux:select.option>
            ...
            <!-- Contacto -->
            <section x-cloak x-show="is('contacto')"
                x-transition:enter="transition transform-gpu ease-out duration-200"
                x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0"
                x-transition:leave="transition transform-gpu ease-in duration-200"
                x-transition:leave-start="opacity-100 translate-x-0" x-transition:leave-end="opacity-0 -translate-x-4"
                role="tabpanel" :id="panelId('contacto')" :aria-labelledby="tabId('contacto')" data-panel="contacto"
                class="absolute inset-0 w-full">
                <div
                    class="card-surface rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm w-full">
                    <div
                    ...
                    <div class="px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model="estado_residencia" placeholder="Selecciona un estado...">
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model="ciudad_residencia" placeholder="Selecciona una ciudad...">
            ...
            <!-- Escolares -->
            <section x-cloak x-show="is('escolares')"
                x-transition:enter="transition transform-gpu ease-out duration-200"
                x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0"
                x-transition:leave="transition transform-gpu ease-in duration-200"
                x-transition:leave-start="opacity-100 translate-x-0" x-transition:leave-end="opacity-0 -translate-x-4"
                role="tabpanel" :id="panelId('escolares')" :aria-labelledby="tabId('escolares')"
                data-panel="escolares" class="absolute inset-0 w-full">
                <div
                    class="card-surface rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm">
                    <div
                        class="rounded-t-2xl border-b border-neutral-200 dark:border-neutral-800 bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 p-4 text-white">
                    ...
                    <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 items-center">
                        <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="bachillerato_procedente"
                                    placeholder="Ingresa el nombre del bachillerato" />
                        ...
                        <div class="md:col-span-2 lg:col-span-1">
                            <div
                                class="rounded-2xl border border-dashed border-neutral-300 dark:border-neutral-700 p-4 sm:p-5">
                                <p class="text-sm font-medium text-neutral-700 dark:text-neutral-200 mb-3">Foto del
                                    estudiante</p>
                    ...
                    <div class="flex items-center justify-between gap-3 px-4 sm:px-6 pb-5">
                        ...
                        <div class="flex items-center gap-3">
                            <flux:button type="button" class="guardar-btn" @click="submit()">
                                Guardar inscripción
                            </flux:button>
                        </div>
                    </div>
    ...
    (function() {
        const registerWizard = () => {
            ...
            window.Alpine.data('wizard', ({
                ...
                current: initial,
                persistKey,
                loading: true, // loader activo al inicio
                ...
                init() {
                    ...
                    this.$nextTick(() => {
                        requestAnimationFrame(() => {
                            this.attachObserver();
                            this.loading =
                                false; // ocultar loader cuando ya se midió
                        });
                    });
                ...
                isCompleted(n) {
                    return this.indexOf(n) < this.index();
                },
                get progress() {
                    const i = this.index(),
        ...
        // Si Alpine ya está disponible (caso navegación Livewire)
        if (window.Alpine) {
            registerWizard();
        } else {
            // Caso primer carga de la app
            document.addEventListener('alpine:init', registerWizard);
        }
    })();
</script>
