...
<head>
    ...
    <title>403 | SWCE - Acceso denegado</title>
                ...
                <div class="p-8 sm:p-10 lg:p-12">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="mt-4 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base dark:text-neutral-300">
                            No tienes permisos para acceder a esta página dentro del sistema SWCE.
                            Esto puede ocurrir porque la ruta está protegida, fue movida o no existe dentro del
                            sistema.
                        </p>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm leading-6 text-slate-600 dark:text-neutral-300">
                                        Si crees que deberías tener acceso a esta página, por favor contacta al
                                        administrador del sistema para solicitar los permisos necesarios.
                                    </p>
                                </div>
                            </div>
                        </div>
