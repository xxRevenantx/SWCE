...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@400..800&family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
        ...
        <div class="relative z-10 mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8">
            ...
            <header class="mb-10 flex items-center justify-center lg:justify-between">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-3">
                    <img src="{{ asset('imagenes_publicas/logo.png') }}" alt="Logo" class="h-15 w-auto sm:h-14"
                        loading="eager" decoding="async">
                    <span class="sr-only">Ir al inicio</span>
                </a>
                <div class="hidden lg:flex items-center gap-2 text-sm text-zinc-300">
                    <span
                        class="inline-flex items-center gap-2 rounded-full bg-amber-500/15 px-3 py-1.5 text-amber-200 ring-1 ring-amber-500/30">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"
                            aria-hidden="true">
                            <path d="M11 7h2v6h-2V7zm0 8h2v2h-2v-2z" />
                            <path d="M12 2 1 21h22L12 2zM4.47 19 12 5.99 19.53 19H4.47z" />
                        </svg>
            ...
            <div class="mx-auto grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <div class="flex items-center">
                    <div
                        class="w-full rounded-3xl border border-zinc-700/60 bg-zinc-900/60 p-6 backdrop-blur-xl shadow-xl sm:p-8 lg:p-10">
                        <div
                            class="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-500/15 px-3 py-1.5 text-xs font-medium text-amber-200 ring-1 ring-amber-500/30 lg:hidden">
                        ...
                        <h1
                            class="text-balance text-center text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-left lg:text-5xl">
                            ¡Gracias por tu paciencia! <span class="text-sky-400">Volvemos pronto</span>
                        </h1>

                        <p
                            class="mt-4 text-pretty text-center text-base leading-relaxed text-zinc-300 sm:text-lg lg:text-left">
                ...
                <div class="flex items-center justify-center">
                    <figure
                        class="floaty w-full max-w-xl rounded-3xl border border-zinc-700/60 bg-zinc-900/60 p-4 backdrop-blur-xl shadow-xl">
                        <img src="https://pagedone.io/asset/uploads/1718004199.png"
                            alt="Ilustración de mantenimiento de sistema" class="h-auto w-full object-contain"
            ...
            <footer class="mx-auto mt-12 max-w-6xl text-center text-sm text-zinc-500">
                © {{ date('Y') }} Sistema Web de Control Escolar para el Centro Universitario Moctezuma A.C. — Todos
